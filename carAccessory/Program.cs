...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        MySqlConnection myDbConn = new MySqlConnection(@"server=127.0.0.1;userid=root;pwd=241580e5d30;persistsecurityinfo=True;database=dvauto;port=3306;sharedmemoryname=");
